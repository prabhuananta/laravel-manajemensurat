        ...
        <div
            ...
            <form action="/penggunabaru" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="default-input" placeholder="Nama" name="name" value="{{ old('name') }}"
                        required
                ...
                <div>
                    ...
                    <input type="email" id="default-input" placeholder="Email" name="email" value="{{ old('email') }}"
                        required
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>
                <div>
