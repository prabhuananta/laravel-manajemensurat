    ...
    <div class="fixed backdrop-blur-xs w-full h-full top-0 left-0">
        <div
            ...
            <span class="flex justify-between gap-5">
                <h1 class="font-semibold text-lg">Edit Verifikator</h1>
                <a href="/verifikator" class="bg-gray-50 rounded-sm size-8 hover:bg-gray-100 hover:cursor-pointer">
            ...
            <form action="/verifikator/update/{{ $datas->id }}" method="POST" class="space-y-4"
