...
@section('content')
<main class="w-full bg-white m-4 rounded-md p-5">
    <form action="./suratbaru" method="POST" class="max-w-md mx-auto">
        @csrf
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" name="judul_surat" id="judul_surat"
                class="block py-2.5 px-0 w-full text-base font-semibold text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                placeholder=" " required />
            <label for="judul_surat"
