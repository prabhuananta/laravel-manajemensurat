...
<body class="text-gray-500">
    <section class="flex w-full h-screen bg-gray-100">

        <!-- sidebar -->
        <nav class="items-center justify-center h-screen p-8 overflow-y-auto bg-white rounded-lg min-w-fit">
            <span class="text-2xl font-bold">Manajemen Surat</span>
            <hr class="my-6">
                ...
                <li>
                    ...
                    <div class="mt-2 panel">
                        <ul class="ml-4 space-y-2 list-disc list-inside">
                            <li><a href="#">Daftar Surat Masuk</a></li>
                            <li><a href="#">Disposisi</a></li>
                            <li><a href="#">Log Surat Masuk</a></li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div class="mt-2 panel">
                        <ul class="ml-4 space-y-2 list-disc list-inside">
                            <li><a href="#">Registrasi Surat Keluar</a></li>
                            <li><a href="#">Daftar Surat Keluar</a></li>
                            <li><a href="#">Log Surat Keluar</a></li>
                            <li><a href="#">Verifikasi Surat Keluar</a></li>
                            <li><a href="#">Tandatangan Surat Keluar</a></li>
                        </ul>
                    </div>
                </li>
                <li class="py-2 text-xs font-bold">
        ...
        <main class="w-full m-4">
            ...
            <div class="flex justify-between mb-5">
                ...
                <div class="flex items-center gap-2 px-3 py-1 bg-white rounded-md w-fit">
                    ...
                    <div class="space-y-1">
                        <span class="text-sm font-semibold">admin@gmail.com</span>
